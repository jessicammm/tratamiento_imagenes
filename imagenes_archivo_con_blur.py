...
# Imágenes obtenidas de una carpeta
...
class imagen():
    def __init__(self, origen):
        ...
        if isinstance(origen, Image.Image):
            ...
            try:
                ...
                buffer = BytesIO(base64.b64decode(origen))
    ...
    def save(self):
        self.im.save('resultados_imagenes_archivo_con_blur/vertical2', FORMATO_RESULTADO)
